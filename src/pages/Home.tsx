...
useEffect(() => { document.title = 'CT-TAE Simulados' }, [])


const href = `/quiz?syllabus=${encodeURIComponent(syllabus)}&n=${count}&m=${minutes}&seed=${seed}`
...
<a className="btn" href={href}>Iniciar simulado</a>
</div>
)
}